            ...
            <tbody>
                ...
                foreach ($employees as $employee) {
                    ...
                    <?php } ?>
                            ...
                            <input type="hidden" class="editInput" name="cat_id" value="<?php echo $employee['category_id'] ?>" >
                        </td>
                        <td>
                        ...
                        <td>
                            <button class="btn btn-warning editBtn" style="float: none;"><i class="glyphicon glyphicon-pencil"></i></button>
                            <button class="btn btn-danger deleteBtn" style="float: none;" onclick="delete_employee(<?php echo $employee['id']; ?>)"><i class="glyphicon glyphicon-remove"></i></button>
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.status == 'ok') {
                trObj.find(".editSpan.nme").text(response.data.name);
                trObj.find(".editSpan.cnct").text(response.data.contact_number);
                trObj.find(".editSpan.hby").text(response.data.hobby);
